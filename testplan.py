...
class TestPlan:
    ...
    def run_testplan(self, http):
        ...
        for testcase_id_str in testcases_id_for_testplan:
            ...
            testcase_summary = testcase_info[0]['summary']
            testcase_summary = testcase_summary[3:-5]
            logger.info('test case summary: %s' % testcase_summary)
            ...
            testcase_obj = TestCase(testcase_id, testcase_name, testcase_steps, testcase_isactive, self.testproject, testcase_summary, self.testplan_name)
            ...
            data = (executed_history_id, testcase_id, str(testcase_name), testsuite_name, self.testplan_name, self.testproject, 'Block', '2018/07/08 08:00:00')
            ...
            testcase_obj.find_autocase(testcase_summary)
